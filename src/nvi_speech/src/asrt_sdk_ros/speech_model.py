...
class ModelSpeech:
    ...
    def load_model(self, filename):
        ...
        self.list_symbol_dic, _ = load_pinyin_dict(current_dir+load_config_file(current_dir+DEFAULT_CONFIG_FILENAME)['dict_filename'])
    ...
    def recognize_speech(self, wavsignal, fs):
        ...
        r_str = []
        for i in r1:
            r_str.append(self.list_symbol_dic[i])
