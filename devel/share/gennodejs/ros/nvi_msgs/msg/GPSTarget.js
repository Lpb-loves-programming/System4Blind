...
class GPSTarget {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('direction')) {
        ...
        this.direction = new geometry_msgs.msg.Point();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = geometry_msgs.msg.Point.serialize(obj.direction, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GPSTarget(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [status]
    data.status = _deserializer.int8(buffer, bufferOffset);
    // Deserialize message field [direction]
    data.direction = geometry_msgs.msg.Point.deserialize(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GPSTarget(null);
    ...
    if (msg.direction !== undefined) {
      resolved.direction = geometry_msgs.msg.Point.Resolve(msg.direction)
    }
    else {
      resolved.direction = new geometry_msgs.msg.Point()
    }
