...
(cl:defmethod cl:initialize-instance :after ((m <HeaderString>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HeaderString)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nvi_msgs-msg:<HeaderString> is deprecated: use nvi_msgs-msg:HeaderString instead.")))
