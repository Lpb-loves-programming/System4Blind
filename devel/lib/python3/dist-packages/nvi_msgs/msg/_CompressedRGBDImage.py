...
"""autogenerated by genpy from nvi_msgs/CompressedRGBDImage.msg. Do not edit."""
import codecs
import sys
...
class CompressedRGBDImage(genpy.Message):
  _md5sum = "9ced99430bcd6c0b779e815bf297af1c"
  _type = "nvi_msgs/CompressedRGBDImage"
...
"""
  __slots__ = ['header','rgb','depth']
  _slot_types = ['std_msgs/Header','sensor_msgs/CompressedImage','sensor_msgs/Image']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CompressedRGBDImage, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.rgb is None:
        self.rgb = sensor_msgs.msg.CompressedImage()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.rgb.format = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.rgb.format = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
