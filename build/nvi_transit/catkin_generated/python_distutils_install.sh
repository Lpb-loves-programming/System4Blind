...
echo_and_run cd "/home/juhaokun/ros_test/src/nvi_transit"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/juhaokun/ros_test/src/nvi_transit/setup.py" \
     \
    build --build-base "/home/juhaokun/ros_test/build/nvi_transit" \
    install \
    --root="${DESTDIR-/}" \
